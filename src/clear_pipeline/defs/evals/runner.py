...
from clear_pipeline.defs.evals.candidates import Candidate
from clear_pipeline.defs.knowledgebase import chunks as _chunks
from clear_pipeline.defs.knowledgebase import datapoints_extract as _dp
from clear_pipeline.defs.knowledgebase import enrich as _enrich
from clear_pipeline.defs.knowledgebase._pdf_extract import (
    extract_pages,
    extract_pages_pypdf,
)
from clear_pipeline.providers import make_llm_provider
from clear_pipeline.providers.llm import LLMProvider, OpenAICompatibleProvider

OPENROUTER_BASE_URL = "https://openrouter.ai/api/v1"

# The eval PDFs and outputs live under <repo root>/evals. In a source checkout
# the repo root is five parents up (evals/ → defs/ → clear_pipeline/ →
